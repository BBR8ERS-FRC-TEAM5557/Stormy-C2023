 ...
 */
public abstract class ServoMotorSubsystemRel extends SubsystemBase {
    ...
    // Recommend initializing in a static block!
    public static class ServoMotorSubsystemRelConstants {
        ...
        public boolean kEncoderInverted = false;
        ...
        public double kPositionDeadband = 0; // Ticks
    ...
    protected final ServoMotorSubsystemRelConstants mConstants;
    protected final CANSparkMax mMaster;
    protected final CANSparkMax[] mSlaves;

    protected final SparkMaxPIDController mMasterPID;
    protected final RelativeEncoder mMasterEncoder;

    public ServoMotorSubsystemRel(final ServoMotorSubsystemRelConstants constants) {
