...
public class SwerveModule {
     ...
     * @param maxVelocity  the maximum drive velocity of the module in meters per
     *                     second
     */
    public SwerveModule(SwerveModuleIO io, int moduleNumber, double maxVelocity) {
        ...
        /*
         * set DEBUGGING to true to view values in Shuffleboard. This is useful when
         * determining the steer offset constants.
         */
        if (DEBUGGING) {
    ...
    public SwerveModuleState getState() {
        ...
        Rotation2d angle = Rotation2d.fromRadians(inputs.anglePositionRad);
