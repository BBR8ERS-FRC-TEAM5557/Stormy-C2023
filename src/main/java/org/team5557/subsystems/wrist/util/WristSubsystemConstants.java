...
public class WristSubsystemConstants {
    ...
    static {
        ...
        kWristConstants.kAcceleration = Math.pow(kWristConstants.kCruiseVelocity, 2); // units / s / s
        kWristConstants.profileConstraints = new TrapezoidProfile.Constraints(kWristConstants.kCruiseVelocity,
                kWristConstants.kAcceleration);
    ...
    public static final WristConstants kWristJointConstants = new WristConstants();
    static {
        kWristJointConstants.mass = 1.0;
        kWristJointConstants.length = Units.inchesToMeters(14.0);
        kWristJointConstants.moi = 1.0;
        kWristJointConstants.cgRadius = Units.inchesToMeters(5.0);
        kWristJointConstants.minAngle = -90.0; // degrees
        kWristJointConstants.maxAngle = 180.0; // degrees
        kWristJointConstants.reduction = 50.0 / 1.0;
    }

    public static MotionProfileConstraints motionConstraints = new MotionProfileConstraints(kWristConstants.kCruiseVelocity, -kWristConstants.kCruiseVelocity, kWristConstants.kAcceleration);
}
